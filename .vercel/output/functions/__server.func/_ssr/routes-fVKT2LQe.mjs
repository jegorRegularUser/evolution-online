...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-fVKT2LQe.js
...
function TraitTooltip({ def, pair, disabled, anchorRect, id }) {
...
var FoodDots = (0, import_react.memo)(function FoodDots({ animal }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		title: `Еда ${animal.food} / ${need}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center gap-1",
			children: [
				Array.from({ length: need }).map((_, i) => i < filled ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					src: TOKEN.meat,
					alt: "",
					className: "token-pop size-3.5 rounded-full"
				}, i) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-block size-3.5 rounded-full border border-ink/40 bg-parchment-2" }, i)),
				animal.food > need ? Array.from({ length: animal.food - need }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					src: TOKEN.plant,
					alt: "",
					className: "token-pop size-3.5 rounded-full"
				}, `x${i}`)) : null,
...
*/
var TraitChip = (0, import_react.memo)(function TraitChip({ type, pair, disabled, fresh }) {
...
*/
var AnimalCard = (0, import_react.memo)(function AnimalCard({ animal, name, selected, dimmed, highlight, dying, freshSince }) {
	const fed = isFed(animal);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-animal-id": animal.id,
		className: cn("animal-card anim-card-in relative w-[168px] shrink-0 cursor-pointer rounded-[var(--radius-lg)] border bg-parchment p-3 text-left text-ink shadow-[var(--shadow-card)] transition-[transform,border-color,opacity,box-shadow] duration-[var(--motion-fast)] ease-[var(--ease-out)]", selected ? "border-clay ring-2 ring-clay/40" : "border-ink/10", highlight ? "ring-2 ring-accent" : "", dimmed ? "opacity-45" : "", dying ? "dying-pulse border-danger/60" : "", "hover:-translate-y-0.5"),
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-1 flex items-start justify-between gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "font-display text-sm tracking-tight",
					children: hasTrait(animal, "carnivore") ? "Хищник" : hasTrait(animal, "swimming") ? "Водное" : "Животное"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
								className: "text-fg",
								children: "Развитие."
							}), " По кругу выкладывайте по одной карте: новое животное или свойство. Свойства кладутся лицом вверх — все видят, кто что выложил. Двойные карты — одно из двух свойств. Паразит только на чужих. Пас — и больше не играете в этой фазе; когда спасовали все, фаза заканчивается."] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
								className: "text-fg",
...
var PlayerSection = (0, import_react.memo)(function PlayerSection({ p, isHuman, actorId, thinking, interactions, dying, freshSince, style }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		}), p.animals.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-xs text-subtle",
			children: isHuman ? "Выложите животное из руки" : "Нет животных"
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "flex flex-wrap gap-2",
			children: p.animals.map((a) => {
...
function CenterField({ year, lastYear, phase, bank, deckLeft, foodRoll, lastLog, actorName, deaths, style }) {
...
function DevDock({ human, intent, disabled, onPlayAnimal, onPickTrait, onPass }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-2",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-xs text-muted",
				children: disabled ? "Ход соперника — карты остаются у вас" : intent.kind === "playTrait" ? "Выберите животное для свойства" : intent.kind === "playPair" && !("first" in intent && intent.first) ? "Парное свойство: выберите первое животное" : intent.kind === "playPair" ? "Второе животное пары" : "Карта как животное или свойство"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				variant: "secondary",
				size: "sm",
				onClick: onPass,
...
function FeedDock({ acts, intentKind, bank, onIntent, onSkip }) {
	const dispatch = useGameStore((s) => s.dispatch);
					...
					children: [
						...
						tails.map((a) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								variant: "secondary",
								onClick: () => onPick(a),
								children: ["Отбросить ", tr ? TRAITS[tr.type].name : "свойство"]
							}, a.discardTraitId);
						}),
