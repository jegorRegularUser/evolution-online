...
var grokOgIdentity = { "site": {
	...
	"card": "custom",
	"color": "111410",
	"description": "Происхождение видов — создавайте животных, играйте свойства, охотьтесь и выживайте.",
	"image": "/og.jpg",
	"banner": "/x-banner.jpg"
} };
//#endregion
...
var _lazy_0EeKWt = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_0EeKWt
	};
	return ((_m, p) => {
		return {
			data,
