 ...
 *
 * Официальный PDF правил не публикует стартовые значения Злака и Лианы и
 * максимум Лианы — они восстановлены по иллюстрациям правил и картам
 * (Злак подтверждён иллюстрацией №1, Гриб — иллюстрацией №2: старт 1,
 * максимум 4) и помечены «(реконструкция)» там, где остаются пробелом.
 */
...
export const PLANTS: Record<PlantKind, PlantDef> = {
  ...
  grass: {
    ...
    name: "Злак",
    description:
      "Разрастается по схеме 1→2, 2→3, 3+→5 (максимум 5). Появляется с 2 фишками (карта на иллюстрации №1 правил).",
    startFood: 2,
    maxFood: 5,
    growth: [
      [3, 5],
  ...
  fungus: {
    ...
    name: "Гриб",
    description:
      "Всякий раз, когда погибает любое животное, на каждом грибе появляется 1 фишка (максимум 4 красных фишки, увеличенный фрагмент иллюстрации №2 правил). Появляется с 1 фишкой (та же иллюстрация). Хищники могут брать с него еду.",
    startFood: 1,
    maxFood: 4,
    growth: [],
    shelters: 0,
  ...
  carnivorous: {
    ...
    name: "Хищное",
    description:
      "Раз в фазу питания атакует: контратакует животное, тянущее с него еду (игнорируя одну его защиту), либо один из игроков направляет его на любое животное. Съело животное — 2 фишки, получило хвост — 1. Съело ядовитое — погибает в вымирание. Максимум 6 фишек, стартует пустым. Хищники могут брать с него еду.",
    startFood: 0,
    maxFood: 6,
    growth: [],
    shelters: 0,
