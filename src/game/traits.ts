...
export const TRAITS: Record<TraitId, TraitDef> = {
  ...
  remora: {
    ...
    short: "Прилипала",
    description:
      "Сама по себе не переезжает. Когда объявлена миграция, каждая прилипала той же местности может уехать следом за мигрантом — по решению владельца, в порядке хода. В Океане следуют только водоплавающие. Спящие прилипалы остаются на месте.",
    isPair: false,
    opponentOnly: false,
    stackable: false,
    extraFood: 0,
  ...
  herding: {
    ...
    short: "Стадность",
    description:
      "Стадных нельзя атаковать, пока их на одной территории не меньше, чем хищников. Пересчёт общий: все стадные, даже чужие, против всех хищников и хищных растений этой территории.",
    isPair: false,
    opponentOnly: false,
    stackable: false,
    extraFood: 0,
  ...
  nematocysts: {
    ...
    short: "Стрекат.",
    description:
      "Даже при неудачной атаке у напавшего хищника до конца фазы питания отключаются все свойства, а потребность в еде становится равной 1. Карты сохраняются; после проверки голода свойства восстанавливаются. Если нападение случилось в Океане, парализованного хищника ещё и выбрасывает на континент.",
    isPair: false,
    opponentOnly: false,
    stackable: false,
    extraFood: 0,
  ...
  budding: {
    ...
    short: "Почков.",
    description:
      "Один раз за год в начале вашего хода фазы развития вид почкует ещё одно животное: карта на него уходит из личной колоды. Обычный предел численности «не больше числа ваших видов» почкование обходит.",
    isPair: false,
    opponentOnly: false,
    stackable: false,
    extraFood: 0,
