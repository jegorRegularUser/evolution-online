 ...
 *  - множественные формы русских слов задаёт сам шаблон: `{n:card}` —
 *    карта/карты/карт; вложенный параметр не меняет сигнатуру `t`;
...
export const ru = {
  ...
  "lobby.deckInfo": "Колода из {n:cardGen} · ≈{years:year} партии",
  ...
  "lobby.inviteHint": "Отправьте ссылку друзьям — они войдут по ней в одно касание.",
  ...
  "wait.position":
    "Вы на {place:ordinalM} месте в очереди. Как только место освободится, вас посадят автоматически.",
  ...
  "rules.base.intro":
    "Базовая русская «Эволюция» (Правильные игры, 2010). Колода 84 карты, 2–4 игрока. Год состоит из четырёх фаз, ход — ваш черед в одной из фаз. Побеждает тот, чьи животные набрали больше очков после последнего года.",
  "rules.base.year": "Год и фазы",
  "rules.base.dev": "Развитие.",
  "rules.base.dev.text":
    "В свой ход фазы развития выкладывайте одну карту: новое животное или свойство. Свойства лежат лицом вверх, все видят, кто что выложил. Двойная карта играется одной из двух сторон. Паразит кладётся только на чужих. Парное свойство (симбиоз, сотрудничество, взаимодействие) ложится между двумя животными: на пару одно такое свойство. Упрощение онлайн-версии: у одного животного может быть не больше двух парных свойств, и пары нельзя замыкать в кольцо. Спасовали — больше в этой фазе не играете; когда спасовали все, фаза заканчивается.",
  ...
  "rules.cont.newTraits.text":
    "Стадность: пока стадных на территории не меньше, чем хищников, их нельзя есть. Стрекательные клетки: даже при неудачной атаке у напавшего хищника до конца фазы питания не действуют все свойства, а потребность становится 1; карты сохраняются, и после проверки голода свойства возвращаются. Если нападение произошло в Океане, парализованного хищника выбрасывает на континент. Регенерация: съеденное хищником животное возвращается — в фазе вымирания владелец выкладывает карту из руки, а если рука пуста, из колоды, новым животным; добора за него нет. Рекомбинация (парная): раз за год, в свой ход питания, партнёры отдают друг другу по одному непарному свойству (дубль уходит в сброс; потерявший «Водоплавающее» в Океане переселяется на континент). Неоплазия — вирус: играется только на чужое животное и каждый год в начале определения кормовой базы поднимается, выключая очередное непарное свойство (выключенное не работает и очков не даёт); когда выключать нечего, животное немедленно погибает. Вирусные свойства (паразит, неоплазия) помечены фиолетовым.",
  ...
  "rules.plants.intro":
    "Дополнение «Растения» (Правильные игры, 2016): 36 двусторонних карт — свойство растения либо свойство животного. В онлайн-версии совместимо с «Континентами» и «Случайными мутациями»; с «Травой и грибами» включить нельзя. Связка с мутациями упрощена: отдельной колоды свойств растений нет — вскрывается верхняя карта личной колоды.",
  ...
  "rules.plants.carnivorous.text":
    "Раз за фазу питания: контратакует животное, тянущее с него еду (выживший всё равно получает фишку), либо один из игроков направляет его на любое допустимое животное, включая своё. Съело животное — 2 фишки; жертва спаслась, сбросив хвост, — 1; съело ядовитое — гибнет в фазе вымирания.",
  ...
  "rules.fungi.intro":
    "Дополнение «Трава и грибы» (Правильные игры, 2019): 24 длинные карты флоры (6 грибов и 6 трав по 2 копии), 8 меток последствий и 2 новых свойства животных. Кормовая база этого года — все красные фишки на картах флоры; флора — полноправный участник партии и может победить. В онлайн-версии его можно сочетать только с «Континентами»: «Растения» и «Случайные мутации» одновременно включить нельзя.",
  ...
  "rules.terr.ocean":
    "Мир воды: здесь живут только водоплавающие, база 5/7/9 по числу игроков. Обычный путь на континент — миграция. Исключения: парализованного стрекательными клетками хищника выбрасывает на берег, а животное, потерявшее «Водоплавающее» при рекомбинации, переселяется на выбранный континент.",
  ...
  "final.win": "Ваши животные доминируют",
  ...
  "final.defeat.discardTie":
    "Очки равны — {total}, но ничью решил сброс: у лидера {leader:cardGen}, у вас {human:cardGen}.",
  ...
  "tutorial.s1.p2":
    "Побеждает тот, чьи животные после последнего года наберут больше очков: 2 очка за каждое животное вида и по очку за каждое свойство.",
  "tutorial.s1.p3":
    "Партия занимает 10–20 минут: выберите число игроков, сложность ботов и дополнения — и вперёд.",
  "tutorial.s2.title": "Развитие",
  "tutorial.s2.p1":
    "В свой ход фазы развития разыгрывайте одну карту: как новое животное или как свойство на свой вид. Двойная карта — одно из двух свойств на выбор.",
  "tutorial.s2.p2":
  ...
  "tutorial.s3.p1":
    "В базовой игре и с «Континентами» кормовую базу определяют кубики — это красные фишки. С «Растениями» и «Травой и грибами» еда лежит на картах, а броска нет. Накормите животных по потребности: нажмите на подсвеченную карточку или кнопку «Взять еду».",
  "tutorial.s3.p2":
  ...
  "tutorial.s3.p3":
    "Игроки ходят по очереди, пока есть еда и желающие: один ход длится до нажатия «Закончить ход».",
  "tutorial.s4.title": "Охота",
  "tutorial.s4.p1":
    "Кнопка «Охота» у хищника подсвечивает допустимых жертв: «Большого» не съест хищник без такого же свойства, водного — только водный хищник, стадность защищается числом.",
  "tutorial.s4.p2":
    "Жертва может спастись: «Быстрое» бросает кубик, «Камуфляж» прячет животное, «Отбрасывание хвоста» жертвует хвостом. Съеденная добыча даёт хищнику 2 синие фишки.",
  "tutorial.s4.p3":
  ...
  "tutorial.s5.p2":
    "В финале очки считают по живым животным, свойствам и бонусам: «Хищник» и «Большой» дают по 1 дополнительному очку, «Паразит» — 2.",
  "tutorial.s5.p3":
    "Счёт каждого игрока виден на его табло рядом со сбросом. При полном равенстве очков сброс решает, кто выше.",
  ...
  "card.plantAttackedTitle": "Хищное растение уже атаковало в этой фазе питания",
  ...
  "game.madBanner": "Безумие: в этот ход вашими животными управляет бот — сосед не участвует (в онлайн-версии пока не реализовано управление соседом)",
  "game.lastYearBanner": "Последний год — после его завершения партия закончится",
  ...
  "game.wait.madness": "Безумие: ход {name} проводится ботом (в онлайн-версии пока не реализовано управление соседом)…",
  "game.wait.actor": "{name} ходит…",
  "game.wait.waiting": "Ожидание",

  // ── партия: табло игрока ─────────────────────────────────────────────────
  "game.yourPopulation": "Ваши животные",
  ...
  "game.extinctionN": "Вымирание: потери — {n}",
  ...
  "game.plantsTokens": "фишек на {n:plantPrep} · свободных убежищ: {m}",
  "game.floraTokens": "фишек на {n:floraCardPrep}",
  ...
  "dock.endDevTitle": "Закончить развитие: ваш ход в фазе развития завершён",
  ...
  "dock.feed.skipHungryTitle": "Закончить питание: не накормлено — {n}",
  ...
  "spot.cannotAttack": "{a} не может атаковать до конца фазы питания",
  ...
  "spot.diedManyStarve": "Погибло: {n} (от голода — {m})",
  ...
  "netErr.moveIllegal": "Этот ход уже невозможен — стол обновился. Попробуйте снова",
  "netErr.resigned": "Вы сдались — ваши ходы пропускаются автоматически",
  "netErr.notPlaying": "Партия ещё не началась — ход пока недоступен",
  ...
  "netErr.chatEmpty": "Напишите сообщение",
  ...
  "netErr.reactionMissing": "Сообщение уже недоступно",
  ...
  "netErr.hostOnly": "Это может настроить только хост",
  ...
  "netErr.gameRunning": "Партия ещё идёт — дождитесь финала",
  ...
  "netErr.tooManyBots": "Ботов больше, чем свободных мест",
  "netErr.codeFailed": "Не удалось создать стол — попробуйте ещё раз",
  "netErr.kickSelf": "Себя нельзя ни удалить, ни заменить ботом",
  "netErr.seatFree": "Это место уже свободно",
  "netErr.kickBot": "Бота убирают или заменяют кнопкой «Бот»",
  "netErr.badColor": "Такого цвета нет в палитре стола",
  "netErr.colorSeat": "Цвет выбирают за столом, а не в очереди",
  "netErr.botColor": "Ботам цвет назначает стол",
  "netErr.hostHuman": "Хостом может стать только человек за столом",
  "netErr.waiterGone": "Этот ожидающий уже вышел из очереди",
  "netErr.playersOffline": "Один из игроков не в сети — замените его ботом",
  "netErr.playerOnline": "Игрок ещё в сети — дождитесь отключения",
  "netErr.botChat": "Боты не пишут в чат",
  "netErr.botResign": "Боты не сдаются",
  "netErr.botRename": "Ботов нельзя переименовывать",
  "netErr.emptyName": "Введите имя",
  "netErr.seatMissing": "Ваше место не найдено в партии — вернитесь в меню и войдите снова",
  "netErr.modulesIncompatible":
    "«Трава и грибы» несовместимы с «Растениями» и «Случайными мутациями». Выключите конфликтующие дополнения.",
  "netErr.generic": "Не удалось выполнить действие. Попробуйте ещё раз",
  "netErr.offline": "Нет связи со столом — проверьте интернет и попробуйте ещё раз",
  "netErr.invalidResponse": "Стол вернул неожиданный ответ. Обновите страницу и попробуйте снова",
  ...
  "log.budding": "{name}: «Почкование» — вид растёт до {pop:animalGen}.",
  ...
  "log.basesRoll": "Кормовые базы — Лавразия {l} ({lroll}), Гондвана {g} ({groll}), Океан {o}.",
  ...
  "log.rage": "Бешенство: животное игрока {name} обязано атаковать в этот ход!",
  "log.madness": "Безумие: ход игрока {name} проводится ботом (в онлайн-версии пока не реализовано управление соседом).",
  ...
  "log.insight": "Гриб прозрения: {name} сбрасывает всю руку ({lost:cardAcc}).",
  "log.soaringDrop": "Окрыляющий гриб: парных свойств в сбросе — {dropped}.",
  ...
  "log.grazeBank": "{name}: топотун уничтожает {burned:foodAcc} еды. База: {bank}.",
  "log.migrate": "{name} объявляет миграцию ({count:animal}).",
  ...
  "log.starved": "Вид {name} теряет {deficit:animal} от голода (осталось {left}).",
  ...
  "log.floraWin": "Победа: Трава и грибы ({total:point}).",
  "log.draw": "Ничья: {names}.",
  "log.win": "Победа: {name} ({total:point}).",
  ...
  "feedBlock.huntersUsed": "Все хищники уже охотились в этом году; каждый может повторить охоту в следующем году.",
  "feedBlock.huntLimit": "За один ход атакуют не более двух хищников.",
