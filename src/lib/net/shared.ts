...
/**
 * Палитра мест — восемь контрастных семейств под тёмную тему «атласа».
 ...
 * (различимость при дальтонизме), читались на тёмной подложке и выдерживали
 * контраст текста ≥ 4.5:1 на подложке места — `color-mix(in oklab, <цвет>
 * 12%, var(--color-surface))` (см. seatTint в game-app):
 * — терракота 45°, малина 352°, янтарь 83°, олива 121°, изумруд 158°,
 *   бирюза 200°, синий 256°, фиолет 303° — восемь разных семейств;
 * — относительная яркость от 0.30 (терракота/синий) до 0.53 (олива) —
 *   разница по светлоте сохраняется и при нарушении цветовосприятия;
 * — контраст на 12%-подложке от 4.6:1 (терракота) до 7.3:1 (олива).
